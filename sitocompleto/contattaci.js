...
fetch("contatti.php").then(function (response){ return response.json();}).then(onJsonContact);
fetch("aziende.php").then(function (response){ return response.json();}).then(onJsonAziende);
