<?php
    ...
    if(isset($_SESSION['username']) && isset($_SESSION['email']) && isset($_SESSION['nome']) && isset($_SESSION['cognome'])){
        ...
        #costruisco le query
        $query = " SELECT P.username AS user , P.nome AS nome , P.cognome AS cognome , L.commento AS commento FROM persona P  JOIN comments_cinema L ON P.id_persona = L.id_persona WHERE L.cod = $cod and L.id_comment = (SELECT MAX(id_comment) from comments_cinema ) ";
        #eseguo la query
